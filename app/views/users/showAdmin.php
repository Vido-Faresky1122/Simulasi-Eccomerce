    ...
    <div class="bg-sudi-card rounded-2xl p-7 shadow-xl w-230">
      ...
      <div class="flex items-center gap-4 py-3">
        ...
        <div class="flex-1 min-w-0">
          <p class="text-yellow-300 text-sm font-semibold">Daniel Riady</p>
          
        </div>
        <div class="text-right shrink-0">
          <p class="text-yellow-300 text-sm">H8u******@gmail.com</p>
      ...
      <div class="flex items-center gap-4 py-3">
        ...
        <div class="flex-1 min-w-0">
          <p class="text-yellow-300 text-sm font-semibold">Eduardo Gunawan</p>
          
        </div>
        <div class="text-right shrink-0">
          <p class="text-yellow-300 text-sm">Ed******@gmail.com</p>
