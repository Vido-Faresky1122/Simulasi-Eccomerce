    ...
    <div class="flex flex-col justify-between border-l-2 border-indigo-500 gap-20 pl-6 w-200">
      ...
      <div class="flex items-start gap-12 mb-6 flex-col">
          <div class="flex gap-7 items-center">
            <button class="text-s w-10 h-10 border bg-yellow-300 text-indigo-600 rounded-full transition duration-150 ease-in-out hover:cursor-pointer hover:bg-yellow-100">-</button>
            <span class="text-yellow-300 text-2xl">1</span>
            <button class="text-s w-10 h-10 border text-yellow-300 rounded-full transition duration-150 ease-in-out hover:cursor-pointer hover:bg-yellow-100">+</button>
          </div>
      <div class="flex gap-4">
        <button class="px-8 py-2 border-2 border-yellow-300 text-yellow-300 rounded-lg transition duration-150 ease-in-out hover:bg-yellow-100 font-bold ">
          Beli Sekarang
        </button>
        <a href="/cart">
          <button class="px-8 py-2 bg-yellow-300 text-indigo-600 rounded-lg transition duration-150 ease-in-out hover:bg-yellow-100 w-40 font-bold">
            Keranjang
          </button>
        </a>
      </div>
