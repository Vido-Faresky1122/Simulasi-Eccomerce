    ...
    <div>
      ...
      <div id="paymentList" class="space-y-4">
        ...
        <div class="payment flex justify-between items-center px-5 py-4 rounded-2xl 
                    ...
                    shadow-inner cursor-pointer transition" data-name="VA">
        ...
        <div class="payment flex justify-between items-center px-5 py-4 rounded-2xl 
                    bg-linear-to-r from-[#5a189a] to-[#6a1bb1] 
                    shadow-inner cursor-pointer" data-name="QRIS">
        ...
        <div class="payment flex justify-between items-center px-5 py-4 rounded-2xl 
                    bg-linear-to-r from-[#5a189a] to-[#6a1bb1] 
                    shadow-inner cursor-pointer" data-name="ShopeePay">
        ...
        <div class="payment flex justify-between items-center px-5 py-4 rounded-2xl 
                    bg-linear-to-r from-[#5a189a] to-[#6a1bb1] 
                    shadow-inner cursor-pointer" data-name="COD">
        ...
        <div class="payment flex justify-between items-center px-5 py-4 rounded-2xl 
                    bg-linear-to-r from-[#5a189a] to-[#6a1bb1] 
                    shadow-inner cursor-pointer" data-name="Gopay">
